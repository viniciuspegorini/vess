...
class EvaluateFourLayer extends StatefulWidget {
  @override
  _EvaluateFourLayerState createState() => _EvaluateFourLayerState();
}

class _EvaluateFourLayerState extends State<EvaluateFourLayer> {
  double layer1;
  double grade1;
  double layer2;
  double grade2;
